        ...
        <div class="row px-4 py-4">
            ...
            <section class="adn-section">
                ...
                <div class="main-title-container">
                    <h1 class="main-title">NUESTRO ADN</h1>
                ...
                <div class="section-container">
                    ...
                    <div class="cards-grid">                        <div class="value-card" data-aos="fade-up" data-delay="100">
                        ...
                        <div class="value-card" data-aos="fade-up" data-delay="200">
                            <div class="card-inner">
                ...
                </div> <!-- Sección Principios -->
                <div class="section-container">
                    <div class="section-header text-center">
                        <h2 class="section-title">PRINCIPIOS</h2>
                        <div class="section-line mx-auto"></div>
                    </div>

                    <div class="cards-grid">
                        <div class="value-card" data-aos="fade-up" data-delay="400">
                            <div class="card-inner">
                        ...
                        <div class="value-card" data-aos="fade-up" data-delay="500">
                            <div class="card-inner">
                                <div class="icon-container unidad">
                                    <div class="icon-bg"></div>
                        ...
                        <div class="value-card" data-aos="fade-up" data-delay="600">
                            <div class="card-inner">
                                <div class="icon-container calidad">
                                    <div class="icon-bg"></div>
