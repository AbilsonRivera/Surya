...
<div class="section-page-somos">
    <div class="container">
        <div class="row px-4 py-4">
            ...
            <div class="col-12">
                <p class="page-somos-txt">Déjanos acompañarte en un viaje de sabores, bienestar y conexión. Para
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 my-2">
                        <div class="info-contacto">
                            ...
                            <a href="https://wa.me/573150922525" target="_blank" style="text-decoration: none; color: inherit;">
                                <h5 class="subtitulo-marca" style="cursor: pointer; transition: color 0.3s ease;" 
