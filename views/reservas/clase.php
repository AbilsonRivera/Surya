...
<div class="banner-pages"
    style="background:url('<?= $baseUrl ?>img/banner/pages/portada-somos.jpg') center/cover no-repeat;">
                ...
                <div class="row g-4" id="productos-grid">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <img src="<?= $baseUrl ?>img/<?= htmlspecialchars($articulo['foto'] ?? '') ?>"
                            alt="<?= htmlspecialchars($articulo['nombre'] ?? '') ?>" class="img-fluid rounded-3">
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <form id="formReservaInicial">
                            ...
                            <button type="button" class="btn btn-agendar"
                                onclick="mostrarModalReserva(event)">Siguiente</button>
                        </form>
                    </div>
            ...
            <div id="modalContenidoLogin" style="<?= $usuarioLogueado ? 'display:none;' : '' ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center mt-3">
                        <a href="#" id="toggleLoginRegister" onclick="toggleAuth(); return false;">¿No tienes cuenta?
                            Regístrate</a>
                    </div>
                </div>
            </div>
...
function seleccionarDia() {
    document.querySelectorAll('.cal-dia.selected').forEach(d => d.classList.remove('selected'));
