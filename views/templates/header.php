...
<html lang="es">
  <head>
    ...
    <!-- Styles -->
    <link href="./css/style.css?cache=<?php echo(rand(10,100)); ?>" rel="stylesheet">
...
<script src='https://cdn.jsdelivr.net/npm/fullcalendar@6.1.10/index.global.min.js'></script>
      ...
      <div class="row container">
        <div class="col-12">
          <nav class="navbar navbar-expand-lg navbar-light justify-content-around">
            <img src="./img/logo/logo.png" alt="Logo" width="100" height="auto">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse justify-content-evenly" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link text-center" href="./">Inicio</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="./somos">Somos Surya</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="./mente">Mente</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="./cuerpo">Cuerpo</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="./alma">Alma</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="./contacto">Contáctanos</a></li>

                    <li class="nav-item d-lg-none d-sm-block">
                        <a class="nav-link btn btn-agendar" href="./alma">Ver Clases</a>
                    </li>
                </ul>
            </div>
  ...
  <div class="d-inline-flex align-items-center m-3">
    <a href="admin" title="Mi Perfil">
      <i class="fa-solid fa-circle-user icono-carrito text-dark"></i>
    </a>
  </div>
<?php else: ?>
  <a href="admin/login" class="icono-carrito text-dark m-3" title="Iniciar Sesión">
...
<?php endif; ?>
            ...
            <a href="./alma" class="btn btn-agendar d-lg-block d-none">Ver Clases</a>
          </nav>
        </div>
      </div>
    </div>

    <a href="./cuerpo" title="Nuestro Menú"
      class="cuerpo-float" target="_blank" rel="noopener noreferrer">
