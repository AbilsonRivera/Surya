...
<div class="container mt-4">
    <h2>Editar Servicio</h2>    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="btn_text" class="form-control" value="<?= htmlspecialchars($service['btn_text']) ?>">
        </div>
        <div class="mb-3">
            <label>Enlace Botón</label>
            <input type="text" name="btn_link" class="form-control" value="<?= htmlspecialchars($service['btn_link']) ?>">
        </div>
        <div class="mb-3">
            <label>Orden</label>
            <input type="number" name="order_position" class="form-control" value="<?= htmlspecialchars($service['order_position']) ?>">
        </div>
        <div class="mb-3">
            <label>Icono</label>
